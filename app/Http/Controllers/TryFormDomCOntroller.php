...
class formDomController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $path_sp = Storage::putFileAs('public/sp_kel_dom', $request->file('sp_kel_dom'), $newNama_sp, 'public');
            $path_ktp = Storage::putFileAs('public/ktp_dom', $request->file('ktp_dom'), $newNama_ktp, 'public');
            $path_kk = Storage::putFileAs('public/kk_dom', $request->file('kk_dom'), $newNama_kk, 'public');
            $path_lain = Storage::putFileAs('public/lain_dom', $request->file('lain_dom'), $newNama_lain, 'public');
            $visibility = Storage::getVisibility('sp_kel_dom', $newNama_sp, 'public');
            $
            $data = [
                'sp_kel_dom' => $path_sp,
                'ktp_dom' => $path_ktp,
