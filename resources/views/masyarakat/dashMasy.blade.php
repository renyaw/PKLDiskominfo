      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center mx-auto my-auto">
            ...
            <h3 class="mb-4 text-white">Salatiga Hati Beriman</h3>
            <h5 class="bold text-success">Selamat Datang, {{Auth::user()->nama}}!</h5>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row align-items-center">
          <div class="col">
            <div class="row justify-content-start mb-5">
              <div class="col-md-6">
                    <div class="info">
                        <i class="material-icons text-6xl text-gradient mb-3" style="background-color:#87CEFA;">mail</i>
                        <h5>Surat Keterangan Tidak Mampu</h5>
                        <p>Klik Tombol di Bawah untuk Mengajukan Permohonan SKTM</p>
                        <a href="formSKTM1"><button type="button" class="btn bg-gradient-info btn-sm mb-0 mt-3">SKTM</button></a>
                    </div>

              </div>
              <div class="col-md-6">
                    <div class="info">
                        <i class="material-icons text-6xl text-gradient mb-3" style="background-color:#87CEFA;">apartment</i>
                        <h5>Surat Keterangan Domisili</h5>
                        <p>Klik Tombol di Bawah untuk Mengajukan Permohonan Surat Domisili</p>
                        <a href="formDom"><button type="button" class="btn bg-gradient-info btn-sm mb-0 mt-3">Domisili</button></a>
                    </div>
              </div>
            </div>
            ...
            <div class="row justify-content-start mt-5">
              <div class="col-md-6">
                    <div class="info">
                        <i class="material-icons text-6xl text-gradient mb-3" style="background-color:#87CEFA;">home</i>
                        <h5>Surat Pengantar Kredit</h5>
                        <p>Klik Tombol di Bawah untuk Mengajukan Permohonan Surat Kredit</p>
                        <a href="formKred"><button type="button" class="btn bg-gradient-info btn-sm mb-0 mt-3">Kredit</button></a>
                    </div>

              </div>
              <div class="col-md-6">
                <div class="info">
                  <i class="material-icons text-6xl text-gradient mb-3" style="background-color:#87CEFA;">download</i>
                  <h5>Kumpulan Berkas</h5>
                  <p>Kumpulan Berkas yang Dapat Didownload</p>
                  <a href="kumpulanBerkas"><button type="button" class="btn bg-gradient-info btn-sm mb-0 mt-3">Berkas</button></a>
                </div>
              </div>
            </div>
          </div>
