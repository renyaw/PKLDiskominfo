          ...
          <div class="card z-index-2 ">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
              <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                <h5 class="m-3 text-white">Surat Keterangan Tidak Mampu</h5>
                <i class="material-icons text-6xl text-gradient m-3" style="background-color:#ffff;">mail</i>
              </div>
            </div>
            <div class="card-body">
              <h6 class="mb-0 ">Riwayat Pengajuan</h6>
              <p class="text-sm ">Surat Keterangan Tidak Mampu</p>
              <hr class="dark horizontal">
              <div class="d-flex ">
                <a href="riwayatSKTM" type="button" class="btn btn-outline-info">Lihat Detail</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card z-index-2  ">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
              <div class="bg-gradient-success shadow-success border-radius-lg py-3 pe-1">
                <h5 class="m-3 text-white">Surat Keterangan Domisili</h5>
                <i class="material-icons text-6xl text-gradient m-3" style="background-color:#ffff;">apartment</i>
              </div>
            </div>
            <div class="card-body">
              <h6 class="mb-0 "> Riwayat Pengajuan </h6>
              <p class="text-sm "> Surat Keterangan Domisili </p>
              <hr class="dark horizontal">
              <div class="d-flex ">
                <a href="riwayatDom" type="button" class="btn btn-outline-info">Lihat Detail</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card z-index-2 ">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
              <div class="bg-gradient-dark shadow-dark border-radius-lg py-3 pe-1">
                <h5 class="m-3 text-white">Surat Pengantar Kredit</h5>
                <i class="material-icons text-6xl text-gradient m-3" style="background-color:#ffff;">home</i>
              </div>
            </div>
            <div class="card-body">
              <h6 class="mb-0 "> Riwayat Pengajuan </h6>
              <p class="text-sm "> Surat Pengantar Kredit </p>
              <hr class="dark horizontal">
              <div class="d-flex ">
                <a href="riwayatKred" type="button" class="btn btn-outline-info">Lihat Detail</a>
              </div>
            </div>
          </div>
        </div>
